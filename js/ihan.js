...
function checkin() {
    const url = {
        ...
        headers: {
            ...
            'User-Agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 15_6_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Safari/604.1 com.hanser.club/1.1.5'
        }
    };
...
function getCookie() {
    var cookieName = "毛怪俱乐部";
    var cookieKey = "Cookie_MGClub";
    if ($request.headers) {
        var cookieValue = Object.keys($request.headers).reduce((t, i) => (t[i.toLowerCase()] = $request.headers[i], t), {})['cookie'] || '';
